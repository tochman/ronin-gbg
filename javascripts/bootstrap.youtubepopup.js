...
(function ($) {
    ...
    var methods = {
        ...
        init: function (options) {
            ...
            if ($YouTubeModal == null) {
                $YouTubeModal = $('<div class="modal fade ' + options.cssClass + '" id="YouTubeModal" role="dialog" aria-hidden="true" style="width: 570px !important; margin-left: -245px; ">');
                var modalContent = '<div class="modal-dialog" id="YouTubeModalDialog">' +
                    ...
                    '<strong class="modal-title" id="YouTubeModalTitle"></strong>' +
                    '</div>' +
    ...
    function getYouTubePlayer(URL, width, height) {
        return ['<iframe title="YouTube video player" width="', width, '" height="', height, '" ',
            ...
            'src="', URL, '?controls=0&showinfo=0" frameborder="0" allowfullscreen seamless></iframe>'
        ].join('');
    }
